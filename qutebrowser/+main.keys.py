...
config.bind('td', 'config-cycle colors.webpage.darkmode.enabled true false ;; config-cycle colors.webpage.bg "white" "black"')
# config.bind('tb', 'config-cycle colors.webpage.bg "black" "white"')
