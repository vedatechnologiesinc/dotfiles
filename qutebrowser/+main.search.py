...
## loĵbano
c.url.searchengines["ss"] = "https://la-lojban.github.io/sutysisku/lojban/index.html#seskari=cnano&sisku={}&bangu=en&versio=masno"
c.url.searchengines["es"] = "https://lensisku.lojban.org/en?mode=dictionary&langs=2,1&q={}"
c.url.searchengines["ls"] = "https://sisku.org/?en#{}"
c.url.searchengines["jb"] = "https://jboski.lojban.org/?text={}"

## ebzzry
c.url.searchengines["dotfiles"] = "https://github.com/vedatechnologiesinc/dotfiles/tree/main/{}"

## lisp
c.url.searchengines["l1sp"] = "http://l1sp.org/search?q={}"
c.url.searchengines["lw"] = "https://www.lispworks.com/cgi-bin/search.cgi?q={}&t=_______"
