...
(def bind-toplevel-keys ()
  ...
  ;; windows
  (map! :g "s-<left>" 'evil-window-left
        :g "s-<right>" 'evil-window-right
        :g "s-<up>" 'evil-window-up
        :g "s-<down>" 'evil-window-down)
  ;; main
  (map! :n "K" 'join-line ; was +lookup/documentation
        ...
        :n "] >" 'end-of-buffer
        :n "[ <RET>" 'my-insert-newline-above
        :n "] <RET>" 'my-insert-newline-below
  ...
  (map! :leader
        (:prefix-map
         ...
         (:prefix-map
          ...
          :desc "Clear horizontal space"  "<SPC>" 'delete-horizontal-space
         ...
         (:prefix-map
          ("s" . "sort")
          :desc "Sort by schedule"         "s" 'my-org-sort-entries-by-schedule
          :desc "Sort by deadline"         "d" 'my-org-sort-entries-by-deadline
          :desc "Sort by reverse schedule" "S" 'my-org-sort-entries-by-reverse-schedule
          :desc "Sort by reverse deadline" "D" 'my-org-sort-entries-by-reverse-deadline)
         (:prefix-map
          ("i" . "insert")
